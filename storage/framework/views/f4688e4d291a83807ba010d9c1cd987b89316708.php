...
unset($__errorArgs, $__bag); ?>                            
        ...
        <div class="col-md-6 col-sm-12 text-center background-special align-middle p-0" id="login-background">
            <div class="login-bg">
                <img src="<?php echo e(theme_url('img/frontend/backgrounds/login.jpg')); ?>" alt="">
            </div>
        </div>
    </div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\transkripti\resources\views/default/auth/login.blade.php ENDPATH**/ ?>