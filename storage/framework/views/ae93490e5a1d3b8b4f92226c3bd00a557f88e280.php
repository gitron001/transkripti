...
<script src="<?php echo e(theme_url('js/results.js')); ?>"></script>
...
<script type="text/javascript">
	$(function () {
		...
		var table = $('#userResultTable').DataTable({
			...
			colReorder: true,
			language: {
				"emptyTable": "<div><img id='no-results-img' src='<?php echo e(theme_url('img/files/no-result.png')); ?>'><br><?php echo e(__('No trascribe tasks created yet')); ?></div>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\transkripti\resources\views/default/user/documents/transcribe/index.blade.php ENDPATH**/ ?>