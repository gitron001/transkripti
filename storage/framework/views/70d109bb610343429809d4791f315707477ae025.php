...
<script type="text/javascript">
	...
	FilePond.setOptions({
		maxFileSize: 25 + 'MB',
		maxFiles: 1,
		labelIdle: "<?php echo e(__('Drag & Drop your audio file or')); ?> <span class=\"filepond--label-action\"><?php echo e(__('Browse')); ?></span><br><span class='restrictions'><span class='restrictions-highlight'>.mp3, .mp4, .mpeg, .mpga, .m4a, .wav, .webm</span></span><br><span class='restrictions'></span>",
		required: true,
		instantUpload:false,
		storeAsFile: true,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\transkripti\resources\views/default/user/transcribe/index.blade.php ENDPATH**/ ?>